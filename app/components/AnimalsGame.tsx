...
export default function AnimalsGame({ onBack }: AnimalsGameProps) {
    ...
    const [questions] = useState(getRandomAnimalQuestions(10))
    ...
    const handleAnswerSelect = (answer: string) => {
        ...
        const currentQuestion = gameState.currentQuestion as AnimalQuestion
            ...
            <div className="space-y-8">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        {/* Question */}
                        <div className="mb-8">
                            <div className="relative rounded-2xl overflow-hidden bg-amber-600/90 backdrop-blur-sm aspect-video max-w-2xl mx-auto mb-6 border-2 border-white/20 shadow-lg">
                        ...
                        <AnimatePresence>
                            {showExplanation && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -20 }}
                                    className="mt-8 p-6 bg-amber-600/80 backdrop-blur-sm rounded-xl text-white border-2 border-white/20 shadow-lg"
                                >
