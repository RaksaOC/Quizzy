            ...
            >
                ...
                <div className="relative h-32 sm:h-48 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                    ...
                    {[...Array(10)].map((_, i) => (
                        ...
                        >
                            <Star className="w-4 h-4 sm:w-6 sm:h-6 text-yellow-300 fill-yellow-300" />
                        </motion.div>
                    ))}
                </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:gap-8 mb-6 sm:mb-8">
                            <div className="space-y-1 sm:space-y-2">
                                <div className="text-xl sm:text-2xl">{winner.avatar}</div>
                                <div className="font-bold text-gray-800 text-sm sm:text-base truncate px-2">
                                    {winner.name}
                                </div>
                            ...
                            <div className="space-y-1 sm:space-y-2">
                                <div className="text-xl sm:text-2xl">{loser.avatar}</div>
                                <div className="font-bold text-gray-800 text-sm sm:text-base truncate px-2">
                                    {loser.name}
                                </div>
                                <div className="flex items-center justify-center gap-1 sm:gap-2">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            <motion.button
                                ...
                                className="w-full bg-gradient-to-r from-indigo-500 to-purple-600
                                         text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl
                                         hover:from-indigo-600 hover:to-purple-700 text-sm sm:text-base"
                            >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={onBack}
                                className="w-full bg-gray-100 text-gray-800 font-bold py-2.5 sm:py-3 px-4 sm:px-6 
                                         rounded-lg sm:rounded-xl hover:bg-gray-200 text-sm sm:text-base"
                            >
                                <span className="flex items-center justify-center gap-2">
