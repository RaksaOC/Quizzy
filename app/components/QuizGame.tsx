...
import { BrainCircuit, Star, CheckCircle, XCircle } from 'lucide-react'
...
export default function QuizGame({ onBack }: QuizGameProps) {
    ...
    return (
        <GameLayout
            ...
            gradientColors={GAME_COLORS.quiz}
        >
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className={`
                                            ...
                                            ${!selectedAnswer
                                                ? 'bg-violet-500/80 text-white hover:bg-violet-600/80 border-2 border-white/20'
                                                : isSelected
                                                    ? isCorrect
                                                    ...
                                                    : isCorrect && showExplanation
                                                        ? 'bg-green-500/90 text-white border-2 border-green-400/50'
                                                        : 'bg-violet-400/50 text-white/60 border-2 border-white/10'
                                            }
                        ...
                        <AnimatePresence>
                            {showExplanation && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -20 }}
                                    className="mt-8 p-6 bg-violet-600/80 backdrop-blur-sm rounded-xl text-white border-2 border-white/20 shadow-lg max-w-2xl mx-auto"
                                >
