...
export default function DigitalLiteracyGame({ onBack }: DigitalLiteracyGameProps) {
    ...
    const [questions] = useState(getRandomDigitalLiteracyQuestions(10))
    ...
    return (
        <GameLayout
            ...
            gradientColors={GAME_COLORS.digitalLiteracy}
        >
            <div className="space-y-8">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        {/* Question */}
                        <div className="mb-8">
                            <div className="relative rounded-2xl overflow-hidden bg-cyan-600/90 backdrop-blur-sm aspect-video max-w-2xl mx-auto mb-6 border-2 border-white/20 shadow-lg">
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className={`
                                            ...
                                            ${!selectedAnswer
                                                ? 'bg-cyan-500/80 text-white hover:bg-cyan-600/80 border-2 border-white/20'
                                                : isSelected
                                                    ? isCorrect
                                                    ...
                                                    : isCorrect && showExplanation
                                                        ? 'bg-green-500/90 text-white border-2 border-green-400/50'
                                                        : 'bg-cyan-400/50 text-white/60 border-2 border-white/10'
                                            }
                        ...
                        <AnimatePresence>
                            {showExplanation && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -20 }}
                                    className="mt-8 p-6 bg-cyan-600/80 backdrop-blur-sm rounded-xl text-white border-2 border-white/20 shadow-lg"
                                >
