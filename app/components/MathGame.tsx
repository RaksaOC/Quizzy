...
export default function MathGame({ onBack }: MathGameProps) {
    ...
    const [questions] = useState(generateMathQuestions(20))
    ...
    const handleAnswerSelect = (answer: number) => {
        ...
        const currentQuestion = currentPlayerState.currentQuestion as MathQuestion
                        ...
                        <AnimatePresence>
                            {showExplanation && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -20 }}
                                    className="mt-8 p-6 bg-orange-600/80 backdrop-blur-sm rounded-xl text-white border-2 border-white/20 shadow-lg max-w-2xl mx-auto"
                                >
